...
public class ExpediaPhoneInterview {
	 ...
	 * Usage: to convert infix to postfix: 
	 * Input   :  3 + 4 * 5 - 2  
	 * Output :  3 4 5 * + 2 - 
	...
	private static boolean isOperator(char c) { // Tell whether c is an
												// operator.
	...
	/* Method: lowerPrecedence
	 * Input: op1 and op2 are assumed to be operator characters (+,-,*,/,^).
	 * Usage: Tell whether op1 has lower precedence than op2, where op1 is an
...
/* Reference: http://scriptasylum.com/tutorials/infix_postfix/algorithms/infix-postfix/
